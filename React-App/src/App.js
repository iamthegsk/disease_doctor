  ...
  return (
    ...
    <div className={classes.main}>
      <AppBar className={classes.appbar}>
        ...
        <div className={classes.rest} style={{ display: "flex", justifyContent: "flex-end" }}> {/* Display links horizontally */}
  <Link to="/feedback" className={classes.btn} style={{ marginRight: "10px", fontSize: "16px", textDecoration: "none" }}>Feedback</Link>
  <Link to="/bmi" className={classes.btn} style={{ marginRight: "10px", fontSize: "16px", textDecoration: "none" }}>BMI 🧮</Link>
  <Link to="/druginfo" className={classes.btn} style={{ marginRight: "10px", fontSize: "16px", textDecoration: "none" }}>DrugInfo</Link>
  <Link to="/home" className={classes.btn} style={{ marginRight: "10px", fontSize: "16px", textDecoration: "none" }}>Home🏠</Link>
</div>
      ...
      <div className={classes.text}>
        <Typography variant="h3" weight="550">
