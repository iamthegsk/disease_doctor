...
const AuthPage = () => {
  ...
  const generateUniqueId = () => {
    return Math.random().toString(36).substr(2, 9); // Just a simple example, you might need a more robust solution
  };
  ...
  const signUp = () => {
    ...
    if (password !== confirmPassword) {
      ...
      localStorage.setItem(`userData_${email}`, JSON.stringify(formData));
